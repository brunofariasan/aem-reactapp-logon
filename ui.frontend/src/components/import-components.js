...
const ComponentPageE = withAsyncImport(() => 
    import(
        `../layouts/Login/Login`
        ),
    );
const ComponentPageHo = withAsyncImport(() => 
import(
    `../layouts/Home/Home`
    ),
);

const ComponentPageFooter = withAsyncImport(() => 
import(
    `../layouts/Footer/Footer`
    ),
);

const ComponentImageModel = withAsyncImport(() => 
import(
    `../components/microNew/ComponentImage/ImageModel`
    ),
);

const ComponentHeader = withAsyncImport(() => 
import(
...
MapTo('reactapp/components/meucomponenteimage')(ComponentImageModel);


MapTo('reactapp/components/meucomponenteheader')(ComponentHeader);
